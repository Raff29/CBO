...
app.use(express.static(__dirname + '/server/img'))
...
app.post('/addCustomer', (req, res) => {
  var firstName = req.body.param1;
  var lastName = req.body.param2;
  var email = req.body.param3;
  var phone = req.body.param4;
  var birth = req.body.param5;
  var address = req.body.param6;
  var sin = req.body.param7; 
  var gender = req.body.param8;
  var address2 = req.body.param9;
  var city = req.body.param10;
  var province = req.body.param11;
  var postal_code = req.body.param12;
  var notes = req.body.param13;

  custome_insertion(firstName, lastName, email, phone, birth, address, sin, gender, address2, city, province, postal_code, notes);
